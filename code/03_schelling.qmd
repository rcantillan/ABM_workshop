...
Esta sección realiza un análisis de sensibilidad del modelo de Schelling, que es crucial para entender cómo el modelo responde a cambios en sus parámetros principales. Este experimento explorará sistemáticamente cómo diferentes valores de densidad y umbral de similitud afectan los niveles de segregación resultantes. Para cada combinación de parámetros, se ejecutarán 5 repeticiones para considerar la variabilidad estocástica del modelo.

El experimento permitirá examinar:

- El efecto del umbral de satisfacción en la segregación
- La influencia de la densidad poblacional
- Posibles interacciones entre estos parámetros
- La robustez de los resultados ante la variación de parámetros
