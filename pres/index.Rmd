...
.w-60.fl[
- Craig Reynolds, un científico computacional trabajando en gráficos para películas en los 80s, quería simular de forma realista el comportamiento de bandadas de pájaros.
- **El problema**: codificar manualmente la trayectoria de cada pájaro individualmente sería extremadamente complejo y poco práctico.
- Observó que las aves podían formar bandadas independientemente del número de individuos
- Lo que sugería que cada ave seguía reglas simples basadas solo en información local.
- Buscó crear reglas simples que cada individuo pudiera seguir y que emergentemente produjeran el comportamiento de bandada.
]
